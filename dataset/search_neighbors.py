...
def main(param):
    ...
    train_path_out = 'baseline_neighborhood_train_valid_test/'+split+city+'/n_train.json'
    valid_path_out = 'baseline_neighborhood_train_valid_test/'+split+city+'/n_valid.json'
    test_path_out = 'baseline_neighborhood_train_valid_test/'+split+city+'/n_test.json'
